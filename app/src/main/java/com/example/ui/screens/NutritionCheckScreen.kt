                    ...
                    Button(
                        ...
                        if (isSaving) {
                            ...
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                ...
                                Spacer(modifier = Modifier.width(8.dp))
                                Text("Tersimpan & Terkirim ke Dashboard UKS", color = Color.White, fontWeight = FontWeight.Bold)
                            }
                        } else {
                            Text("Simpan & Kirim ke Dashboard UKS", color = Color.White, fontWeight = FontWeight.Bold)
                        }
                    }
                }
            }
